---
title: "What is Pars Protocol?"
description: "Decentralized financial infrastructure for the Persian diaspora, combining treasury-backed tokens with censorship-resistant governance."
---
...
- [Tokens Overview](/tokens/pars) – Understand PARS, xPARS, and vePARS
- [Governance Guide](/governance/council) – Learn how the Pars Council operates
- [Treasury Management](/treasury/overview) – Explore treasury structure and reserves

## Quick Links

- **Governance Portal**: [pars.vote](https://pars.vote)
- **Protocol Dashboard**: [app.pars.network](https://app.pars.network)
